...
interface JoinMeetingFormProps {
  onJoinMeeting: (data: { userName: string; userEmail: string; isAdmin?: boolean }) => void
}

export function JoinMeetingForm({ onJoinMeeting }: JoinMeetingFormProps) {
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <Card className="bg-white/10 backdrop-blur-lg border-white/20">
            <CardHeader>
              <CardTitle className="text-white">Login to Platform</CardTitle>
              <CardDescription className="text-slate-300">
                Enter your credentials to access the video conference platform
              </CardDescription>
            </CardHeader>
            <CardContent>

  ...
  const users = [
    {
      ...
      totalHours: 120,
      avatar: "JD",
      isCurrentUser: currentUser.userEmail === "john.doe@company.com",
    },
    {
      id: 2,
      name: "Sarah Johnson",
      ...
      totalHours: 95,
      avatar: "SJ",
      isCurrentUser: currentUser.userEmail === "sarah.johnson@company.com",
    },
    {
      id: 3,
      name: "Mike Chen",
      ...
      totalHours: 48,
      avatar: "MC",
      isCurrentUser: currentUser.userEmail === "mike.chen@company.com",
    },
    {
      id: 4,
      name: "Emily Davis",
      ...
      totalHours: 180,
      avatar: "ED",
      isCurrentUser: currentUser.userEmail === "emily.davis@company.com",
    },
    {
      id: 5,
      name: "Alex Rodriguez",
      ...
      totalHours: 32,
      avatar: "AR",
      isCurrentUser: currentUser.userEmail === "alex.rodriguez@company.com",
    },
    {
      id: 6,
      name: "Lisa Wang",
      ...
      totalHours: 65,
      avatar: "LW",
      isCurrentUser: currentUser.userEmail === "lisa.wang@company.com",
    },
    {
      id: 7,
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-600">Manage user accounts and activities</p>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold text-yellow-600">{stats.totalHours}h</p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage user accounts and their activities</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        {user.isCurrentUser && <Badge className="bg-blue-100 text-blue-800 text-xs">You</Badge>}
                      </div>
